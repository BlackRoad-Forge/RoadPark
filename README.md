...
> Queue management and SLA monitoring visualization

Part of the [BlackRoad OS](https://blackroad.io) ecosystem. Forked from [`blackboxprogramming/OpenRCT2`](https://github.com/blackboxprogramming/OpenRCT2).
